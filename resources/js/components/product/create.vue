...
<template>
 ...
 <div class="row">
  <router-link to="/product" class="btn btn-primary">All Product </router-link>
    ...
    <div class="row justify-content-center">
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Tambah Item</h1>
                  </div>
     ...
     <div class="col-md-6">
      <label for="exampleFormControlSelect1">Kod Item</label>
  ...
  <select class="form-control" id="exampleFormControlSelect1" v-model="form.category_id">
     ...
     <div class="col-md-6">
          <label for="exampleFormControlSelect1">Kod Pembekal</label>
 ...
 <div class="col-md-4">
              <label for="exampleFormControlSelect1">Purata Harga</label>
       ...
       <small class="text-danger" v-if="errors.buying_price"> {{ errors.buying_price[0] }} </small>
        ...
        <div class="form-group">
          ...
          <div class="form-row">
            <div class="col-md-6">
              <label for="exampleFormControlSelect1">Tarikh_pembelian</label>
